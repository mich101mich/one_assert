...
//! #         error.downcast_ref::<&'static str>().map(|s| s.to_string())
...
//! );
//!
//! let msg = catch_panic!({ one_assert::assert!(10 <= x); });
//! assert_eq!(msg, "assertion `10 <= x` failed
//!      left: 10
//!     right: 1"
//! );
//!
...
//!
//! [Apache License, Version 2.0]: https://github.com/mich101mich/one_assert/blob/master/LICENSE-APACHE
//! [MIT license]: https://github.com/mich101mich/one_assert/blob/master/LICENSE-MIT
